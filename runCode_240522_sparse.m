...
%             
            ...
            [LocationsOurs,pw_ours(times,l),LocationsOursKnownK,LocationsOursKnownPW,BenchmarkLocations,pw_benchmark(times,l),BenchmarkLocationsKnownK,BenchmarkLocationsKnownPW,tempObjectiveOursMat,tempBenchmarkMat,timeObjective,timeCorr,NullOursMat,...
             NullBenchmarkMat,NumChangeOurs(times,l),NumChangePointsBenchmarkFull(times,l),NumChangePointsBenchmarkKnownNumber(times,l)] = KnownIntervals_5(signal,PwOptions(l),fs,num_change_points,round(signal_length/(PwOptions(l)*fs)),1);
...
%                 changeIdx=DrawChangePoints(pw,fs,signal_length,num_change_points)+1;
                ...
                [RandomChangePoints,Terminate] = DrawChangePoints_220522v2(pw,fs,signal_length,num_change_points,0);
                RandomChangePoints=RandomChangePoints+1;
           end
...
%     
    ...
    SNR_Precision(varStep,l)=mean(Prec(:,l));
